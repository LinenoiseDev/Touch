...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* touch features */
        {"touch", "masternode", &masternode, true, true, false},
        {"touch", "masternodelist", &masternodelist, true, true, false},
        {"touch", "mnbudget", &mnbudget, true, true, false},
        {"touch", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"touch", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"touch", "mnsync", &mnsync, true, true, false},
        {"touch", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"touch", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use touchd, or the -server option to touch-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> touch-cli " + methodname + " " + args + "\n";
}
