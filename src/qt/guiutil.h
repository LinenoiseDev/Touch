...
/** Utility functions used by the touch Qt UI.
 */
namespace GUIUtil
{
...
// Render touch addresses in monospace font
...
// Parse "touch:" URI into recipient object, return true on successful parsing
