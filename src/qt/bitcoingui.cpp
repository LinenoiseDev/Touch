                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Touch Client") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a touch address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and touch: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Touch Client"), this);
    aboutAction->setStatusTip(tr("Show information about Touch Client"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for touch"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your touch addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified touch addresses"));
    ...
    openAction->setStatusTip(tr("Open a touch: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Touch Client help message to get a list with possible touch command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Touch Client client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to touch network", "", count));
}
...
{
    QString strTitle = tr("Touch Client"); // default title
