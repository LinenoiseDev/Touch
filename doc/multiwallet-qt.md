...
In order to support loading of multiple wallets in touch-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is touch.cpp.
...
Changes to touch.cpp
----------------------
touch.cpp is the entry point into touch-qt, and as such, will require some minor modifications to provide hooks for
