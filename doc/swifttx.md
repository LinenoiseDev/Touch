...
This mechanism has been integrated into Bitcore-Node-touch which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/touch-Project/insight-api-touch#web-socket-api](https://github.com/touch-Project/insight-api-touch#web-socket-api) 
* API: [https://github.com/touch-Project/insight-api-touch#swifttx-transactions](https://github.com/touch-Project/insight-api-touch#swifttx-transactions) 
