...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<touch_address\> \<monthly_payment_touch\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ touch, _12_ times over the course of a year totaling _24000_ touch.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<touch_address\> \<monthly_payment_touch\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` touch.
 ...
 * vote-many          - Vote on a touch initiative
 * vote-alias         - Vote on a touch initiative
 * vote               - Vote on a touch initiative/budget
