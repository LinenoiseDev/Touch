...
RESOURCES += src/qt/touch.qrc src/qt/touch_locale.qrc

TRANSLATIONS += src/qt/locale/touch_bg.ts \
                src/qt/locale/touch_de.ts \
                src/qt/locale/touch_en.ts \
                src/qt/locale/touch_es.ts \
                src/qt/locale/touch_fi.ts \
                src/qt/locale/touch_fr.ts \
                src/qt/locale/touch_it.ts \
                src/qt/locale/touch_ja.ts \
                src/qt/locale/touch_pl.ts \
                src/qt/locale/touch_pt.ts \
                src/qt/locale/touch_ru.ts \
                src/qt/locale/touch_sk.ts \
                src/qt/locale/touch_sv.ts \
                src/qt/locale/touch_vi.ts \
                src/qt/locale/touch_zh_CN.ts \
                src/qt/locale/touch_zh_TW.ts
